...
def get_version():
    main_file = os.path.join(CURDIR, "drf_http_response", "main.py")
...
setup(
    ...
    keywords=[],
    scripts=[],
    entry_points={"console_scripts": ["drf_http_response=drf_http_response.responses:main"]},
    zip_safe=False,
